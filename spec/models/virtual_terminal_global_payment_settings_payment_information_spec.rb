...
# Unit tests for CyberSource::VirtualTerminalGlobalPaymentSettingsPaymentInformation
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VirtualTerminalGlobalPaymentSettingsPaymentInformation' do
  before do
    # run before each test
    @instance = CyberSource::VirtualTerminalGlobalPaymentSettingsPaymentInformation.new
  end
  ...
  describe 'test an instance of VirtualTerminalGlobalPaymentSettingsPaymentInformation' do
    it 'should create an instance of VirtualTerminalGlobalPaymentSettingsPaymentInformation' do
      expect(@instance).to be_instance_of(CyberSource::VirtualTerminalGlobalPaymentSettingsPaymentInformation)
    end
  end
