...
module CyberSource
  class Ucv1sessionsPaymentConfigurationsPAYPAL
    ...
    attr_accessor :vaulting_enabled
    ...
    def self.json_map
      {
        :'vaulting_enabled' => :'vaulting_enabled',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'vaultingEnabled')
        self.vaulting_enabled = attributes[:'vaultingEnabled']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          vaulting_enabled == o.vaulting_enabled &&
    ...
    def hash
      [vaulting_enabled, tokenized_payment_method, industry_type].hash
    end
