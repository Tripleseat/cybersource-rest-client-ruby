...
module CyberSource
  class Ucv1sessionsDataOrderInformationShipTo
    ...
    def hash
      [address1, address2, address3, address4, administrative_area, building_number, country, district, locality, postal_code, first_name, last_name, email].hash
    end
